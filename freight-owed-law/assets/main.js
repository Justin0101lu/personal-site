/* Freight Owed Law — site scripts (no dependencies) */
(function () {
  "use strict";
  ...
  if (form) {
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (!configured) {
        ...
        var to = form.getAttribute("data-mailto") || "intake@freightowed.com";
        var lines = [];
      ...
      fetch(action, { method: "POST", body: data, headers: { Accept: "application/json" } })
        ...
        .catch(function () {
          status.textContent = "Something went wrong sending the form. Please call us or email intake@freightowed.com.";
